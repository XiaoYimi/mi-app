<template>
  <layout-tabbar>
    <section class="me-panel">
      <div @click="toProfile" class="me-panel-left">
        <img src="" alt="" class="avartor">
        <span class="ml-10">motto</span>
      </div>
    ...
    <section class="me-order">
      <div class="me-order-bar">
        <span>我的订单</span>
        <span class="color-secondgray">全部订单<i class="iconfont">&#xe604;</i></span>
      </div>
      <div class="option">
        <div
...
export default {
  ...
  methods: {
    toProfile () { this.$router.push({ path: '/profile' }) }
  }
}
</script>
